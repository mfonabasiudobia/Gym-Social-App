...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset("css/style.css")); ?>?v=<?php echo e(uniqid()); ?>">
  ...
  <div class="page-wrapper">
    <div class="row">
      <div class="col-12  text-center d-flex justify-content-center flex-column align-items-center" style="min-height: 100vh;">
          ...
          <div class="text-danger">Oop! Something is wrong. <a href="<?php echo e(route('home')); ?>" class="fw-800 text-danger">GO TO HOME PAGE</a></div>
      </div>
  </div>
  </div>
...
</html><?php /**PATH C:\xampp\htdocs\gym-social-media\resources\views/errors/404.blade.php ENDPATH**/ ?>