    ...
    @scroll.window="showBar = (window.pageYOffset >  innerHeight) ? true : false; pageYOffset = window.pageYOffset;">
     <header 
        ...
        class="flex items-center top-0 left-0 z-50  h-auto w-full">
                   ...
                   <img :src="showBar && !isMobileNavOpen ? '{{asset('images/logo/logo-dark.png')}}' : '{{asset('images/logo/logo-white.png')}}'" class="logo md:absolute top-0 scale-75 left-0 right-0 m-auto" /> 
